...
export const MILESTONE_TIERS: MilestoneTier[] = [
  ...
  },
  {
    ...
    tagline: "Projected: 1,000 Students Funded — 500 Merit + 500 Need-Based (if 50k registrations reached)",
    benefits: [
      "₹9,00,000 Escrowed Scholarship Pool (projected at 50,000 registrations)",
      "🏆 Merit Scholarships (50% of slots): At 50k → Top 250 Boys & Top 250 Girls (100% Mock Performance, No financial need considered)",
      "❤️ Need-Based Scholarships (50% of slots): At 50k → Next 250 Boys & Next 250 Girls from separate eligible pool (Financial need considered)",
