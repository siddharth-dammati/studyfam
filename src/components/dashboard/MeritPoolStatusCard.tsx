    ...
    <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xs">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        <div className="p-4 bg-emerald-50/70 rounded-2xl border border-emerald-100">
          <div className="text-[10px] uppercase font-mono text-emerald-700 mb-1 flex items-center gap-1">
            <Award size={12} /> Scholarship Pool
          </div>
          ...
          <div className="text-[11px] text-emerald-700 font-medium mt-0.5">
            Top {Math.max(funded_students, 20)} Exam Fees Funded
          </div>
        </div>
      </div>

      {/* Prize structure badges */}
      ...
      <div className="pt-4 border-t border-slate-100">
        <div className="flex justify-between text-xs text-slate-500 mb-2 font-medium">
          <span>Target Milestone: {milestone.toLocaleString()}</span>
