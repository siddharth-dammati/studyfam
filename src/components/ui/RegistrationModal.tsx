            ...
            {profile ? (
              ...
              <>
                <button
                  ...
                  className="w-full mb-4 flex items-center justify-center gap-2.5 py-2.5 px-4 text-xs font-semibold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all shadow-xs"
                >
                  ...
                  <span>Continue with Google to Auto-fill</span>
                </button>
